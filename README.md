...
<dependencies>
    <dependency>
    	...
    	<version>0.9.3</version> <!-- Or use any other version including commit hashes -->
    </dependency>
</dependencies>
```
...
## Usage
#### Resources
* [Latest Release Javadocs](https://jitpack.io/com/github/VSETH-GECO/GECo4J/0.9.3/javadoc/)
...
```
Then you can look at the [Javadocs](https://jitpack.io/com/github/VSETH-GECO/GECo4J/0.9.3/javadoc/) to see what you can do with a `IGECoClient`.
